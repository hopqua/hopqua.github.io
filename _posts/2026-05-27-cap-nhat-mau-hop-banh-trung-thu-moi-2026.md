...
- **Hộp 6 bánh mini Kim Sơn Cam**: tông cam nổi bật, phù hợp set bánh mini.
- **Bát Giác Hào Quang Ánh Trăng**: thiết kế bát giác sang trọng, giá tham khảo 36.000đ - 44.000đ.
- **Cúc Nguyệt   Đỉnh 4 bánh kèm hộp trà đỏ**: phù hợp làm quà tặng doanh nghiệp.
- **Hoàng Kim hàng giấy mềm cao cấp màu gold**: lựa chọn cao cấp cho set 4 bánh hoặc 6 bánh.
- **Hộp cứng quai trúc xanh dương 4 bánh kèm trà**: thiết kế chắc chắn, lịch sự.
- **Nguyệt   Liên Ngư 4 bánh trà / 6 bánh**: mẫu hộp trang nhã, dễ phối với nhiều loại bánh.

## Danh sách mẫu mới

{% assign new_products = site.data.products %}

Các mẫu mới đã được cập nhật trong danh mục sản phẩm của website. Khách hàng có thể xem hình ảnh chi tiết, video sản phẩm nếu có và liên hệ để được tư vấn số lượng, giá sỉ, cách phối set bánh.
